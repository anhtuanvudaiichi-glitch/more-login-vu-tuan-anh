...
> Owner role: Security Champion + Backend Lead  
> Status: [SOURCE OF TRUTH] Approved v1.2  
> Last updated: 2026-03-30  
> Related docs: 06-AGENT-API-CONTRACT-MAPPING.md, 08-REPLIT-DEPLOYMENT-AND-ENV-SETUP.md, appendices/hmac-golden-vectors.md, appendices/callback-signature-golden-vectors.md
...
- Không hard-code `AGENT_API_KEY_SECRET` trong source code.
- Đồng bộ thời gian server để tránh lỗi timestamp window 120s.

### 2.2 Key management

- Tên biến môi trường canonical:
  - `AGENT_API_KEY_ID`
...
### 2.3 Legacy alias (deprecated)

| Legacy alias (deprecated) | Canonical key |
|---|---|
