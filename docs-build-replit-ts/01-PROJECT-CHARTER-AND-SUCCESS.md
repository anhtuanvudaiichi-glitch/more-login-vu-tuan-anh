...
> Owner role: Sponsor + PM  
> Status: [SOURCE OF TRUTH] Approved v1.1  
> Last updated: 2026-03-30  
> Related docs: 02-TARGET-ARCHITECTURE-REPLIT-AGENT.md, 03-IMPLEMENTATION-ROADMAP-WBS.md, 09-TEST-PLAN-AND-UAT.md
...
- Agent tích hợp: Python MoreLogin tại `../api`.
